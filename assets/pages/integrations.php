      ...
      >
        <div style="max-width: 350px">
          <h1 class="display-5 fw-bold mb-4">
            Skyrocket your productivity with our&nbsp;<span class="underline"
              >tools</span
            >.
          </h1>
  ...
  <div class="container py-5">
    <div class="row row-cols-1 row-cols-md-2 mx-auto" style="max-width: 900px">
      <div class="col mb-5">
        <img
          ...
          src="assets/img/illustrations/data-management.svg"
        />
      </div>
      <div class="col d-md-flex align-items-md-end align-items-lg-center mb-5">
        <div>
          ...
          <a class="fw-bold link-primary mb-3" href="#"
            >Browse tools&nbsp;<svg
    ...
    <div class="row row-cols-1 row-cols-md-2 mx-auto" style="max-width: 900px">
      <div class="col order-md-last mb-5">
        <img
          class="rounded img-fluid"
          src="assets/img/illustrations/javascript.svg"
        />
      </div>
      <div class="col d-md-flex align-items-md-end align-items-lg-center mb-5">
        <div class="ms-md-3">
          ...
          <a class="fw-bold link-primary" href="#"
            >Browse tools&nbsp;<svg
              xmlns="http://www.w3.org/2000/svg"
              width="1em"
              height="1em"
    ...
    <div class="row row-cols-1 row-cols-md-2 mx-auto" style="max-width: 900px">
      <div class="col mb-5">
        <img
          class="rounded img-fluid"
          src="assets/img/illustrations/report.svg"
        />
      </div>
      <div class="col d-md-flex align-items-md-end align-items-lg-center mb-5">
        <div>
